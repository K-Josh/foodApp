import {Flex, Image, Show, Hide, Box, useDisclosure, useColorMode, Collapse, Button, useColorModeValue, } from '@chakra-ui/react'
...
const Navbar = () => {
  ...
  return ( 
   <>
    <Flex className={`fixed top-0 w-full ${bg ? 'bg-white/80' : 'bg-black/80' } z-50`} justifyContent={'space-between'} gap={{base: 1,}} py={{md:'3px'}} p={{base:1}}
